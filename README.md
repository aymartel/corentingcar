...
sembrar (`USER1_PIN`, `USER2_PIN`) y la fecha ancla con `ANCHOR_DATE`.

Para **cambiar un PIN** más adelante, directamente en la base de datos:
```bash
pnpm db:set-pin user1 4321     # actualiza el pin_hash del perfil 'user1'
pnpm db:set-pin user2 8765
```
